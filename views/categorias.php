    ...
    <!-- Tabs -->
                ...
                <div class="collapse navbar-toggleable-xs" id="collapseEx2" style="padding-left: 330px">
                    <div class="md-form col-md-3" style="position: relative; left: -280px;top: 10px;">
                        <a href="cadcategoria.php" class="btn btn-primary waves-effect waves-light #303f9f indigo darken-4  "><i class="fa fa-plus" ></i>  Categoria</a>
                    </div>
                    <div class="md-form col-md-4">
                        <p><h4>LISTA CATEGORIAS</h4></p>
                    </div>
                    <!--Search form-->
